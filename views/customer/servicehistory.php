...
$events=$conn->getAll(" SELECT service_list.*,services.type,contractors.fname,contractors.lname 
						...
						WHERE service_list.customer_ID = '$CID' AND service_list.state = 'finished' ");
$events2=$conn->getAll(" SELECT service_list.*,services.type
						FROM service_list INNER JOIN services ON service_list.service_ID = services.id 
						WHERE service_list.customer_ID = '$CID' AND service_list.state = 'canceled'");
?>
            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3>View <small>History</small></h3>
                    </div>
                </div>
							...
							<p class="text-muted font-13 m-b-30"></p>
                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
										...
										<th><center>Contractor</center></th>
                                    ...
                                    <tr><center>
                                        ...
                                        <td><center><?=$event['cost']?></center></td>
                                    ...
                                    ?>
                                    <tr><center>
                                        <td><center><?=$event2['type']?></center></td>
                                        <td><center><?=$event2['Date']?></center></td>
                                        <td><center><?=$event2['Time']?></center></td>
                                        <td><center><?=$event2['cost']?></center></td>
										<td><center><?=$event2['location']?></center></td>
									    <td><center><?=$event2['description']?></center></td>
										<td><center>-</center></td>
                                        <td><center><?=$event2['state']?></center></td>
                                    </tr>
                                    <?php
                                   }
                                    ?>
