...
$events=$conn->getAll(" SELECT service_list.ID, services.type, service_list.Date,
						...
						AND service_list.state = 'pending' ");
            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3>Cancel Reservation</small></h3>
                    </div>
                                ...
                                <table class="table table-striped table-bordered" id="cTable" name="cTable" style="width:100%" >
                                    ...
                                    foreach ($events as $event){
                                        ...
                                        <tr id="myRow" name="myRow"  >
											<form action="../../src/store/disableReservation.php" method="post" onsubmit="return confirm('Are you sure you want to cancel this service ? press OK to continue.');">
                                            ...
                                            <td><center><?=$event['state']?></center>
											<input type="hidden" id="hi" name="hi" value="<?=(int)$event['ID']?>">    
                                            </td>
                                            <td><center><input class="btn btn-success" type ="submit" id ="cancel" name =" cancel " value ="cancel"  ></center></td>					
											</form>
                                        </tr>
