...
$events=$conn->getAll(" SELECT services.type, service_list.Date,service_list.Time,service_list.location,service_list.description ,service_list.state, contractors.fname, contractors.lname  FROM service_list,contractors,services WHERE service_list.state='live' AND service_list.customer_ID='$CID' AND service_list.service_ID=services.id AND service_list.contractor_ID=contractors.id ");
