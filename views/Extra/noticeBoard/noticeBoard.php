                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%;">
                                    ...
                                    <tr>
										...
										<th><center>Modified At</center></th>
                                    ...
                                    foreach ($notices as $notice){
                                        ?>
                                        <tr>
                                            <td><center><?=$notice['subject']?></center></td>
                                            <td><center><?=$notice['notice_date']?></center></td>
                                            <td><center><?=$notice['notice_time']?></center></td>
                                            <td><center><?=$notice['description']?></center></td>
                                            <td><center>
                                                <?php
                                                if($notice['status']==1){
                                                    echo "Due Notice";
