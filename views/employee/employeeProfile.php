...
$info=$conn->getOne("SELECT * FROM employees WHERE id = '$CID'");
    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="../../src/store/editEmployeeProfile.php" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="password" class="form-control" name="password" id="password" onchange="form.pwd2.pattern = this.value;" minlength="6" placeholder=" Type Password" required>
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="password2"><h4>Verify Password</h4></label>
                              <input type="password" class="form-control" name="pwd2" id="password2" title="Passwords dose not match" placeholder="Re-Type Password" required>
                          </div>
                      </div>
                      <div class="form-group">
