...
$events=$conn->getAll("SELECT * FROM `contractors` WHERE state='pending'");
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td><center><?=$event['time_created']?></center></td>
										<td><center><a onclick="return confirm('Are you sure you want to verify this contractor? press OK to continue.');" href="../../src/store/enableContractor.php? id=<?=$event['id']?>" class="green">Verify Contractor</a></center></td>
                                    </tr>
                                    <?php
                                   }
                                    ?>
