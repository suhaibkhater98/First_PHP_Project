...
$events = $conn->getAll(
    "SELECT id,fname,lname,email,phone,type,state,time_created from customers 
    UNION 
    SELECT id,fname,lname,email,phone,type,state,time_created from contractors");
