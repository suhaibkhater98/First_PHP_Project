...
$events=$conn->getAll(" SELECT service_list.*,services.type,customers.fname,customers.lname
						...
						WHERE service_list.state = 'finished'");
$events2=$conn->getAll(" SELECT service_list.*,services.type,customers.fname,customers.lname
						FROM service_list INNER JOIN services ON service_list.service_ID = services.id
						INNER JOIN customers ON service_list.customer_ID = customers.id
						WHERE service_list.state = 'canceled'");
?>
            ...
            <div class="">
                ...
                <div class="page-title">
                    <div class="title_left">
                        <h3>Services <small>History</small></h3>
                    </div>
                </div>
                            ...
                            <div class="x_content">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered">
                                    ...
                                    <tr><center>
										...
										<td><center><?=$event['Rating']?></center></td>
