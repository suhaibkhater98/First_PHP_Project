...
$info=$conn->getOne("SELECT * FROM admins WHERE id = '$CID'");
    	...
    	<div class="col-sm-9">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="home">
                <hr>
                  <form class="form" action="../../src/store/editAdminProfile.php" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="password2"><h4>Verify Password</h4></label>
                              <input type="password" class="form-control" name="pwd2" id="password2" title="Passwords Does Not Match" placeholder="Re-enter Password" required>
                          </div>
                      </div>
                      <div class="form-group">
